...
function onTips($obj, text) {
    text='<table><tbody>' +
        '<tr><td>全部房间数</td><td style="text-align: right">100</td></tr><tr><td>已预订房间数</td><td style="text-align: right">52</td></tr>' +
        '<tr><td>剩余房间数</td><td style="text-align: right">20</td></tr><tr><td>预测入住数</td><td style="text-align: right">93</td></tr>' +
        '<tr><td>预测入住率</td><td style="text-align: right">93.00%</td></tr><tr><td>预测NO-SHOW数</td><td style="text-align: right">11</td></tr><tr><td>预测取消数</td><td style="text-align: right">3</td></tr>' +
        '<tr><td>预测团客数</td><td style="text-align: right">55</td></tr><tr><td>预测散客数</td><td style="text-align: right">38</td></tr>' +
        '<tr><td>已预订团客数</td><td style="text-align: right">30</td></tr><tr><td>已预订散客数</td><td style="text-align: right">22</td></tr></tbody></table>'
